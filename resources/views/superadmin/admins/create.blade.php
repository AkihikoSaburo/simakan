...
<body class="bg-brand-snow font-sans text-brand-dark antialiased min-h-screen flex flex-col">
    ...
    <main class="flex-1 max-w-2xl w-full mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-xl font-extrabold tracking-tight text-brand-dark">Registrasi Admin Baru</h2>
                <p class="text-xs text-brand-gray mt-0.5">Silakan isi formulir di bawah ini untuk mendaftarkan akun admin baru.</p>
            </div>
        </div>
